...
(function ($, gettext, Logger, accessibleModal, interpolate) {
  ...
  edx.dashboard.legacy.init = function (urls) {
    ...
    window.analytics.trackLink(
      $verifyButtonLinks,
      "edx.bi.user.verification.resumed",
      generateProperties
    );
    ...
    $(".action-email-settings").click(function (event) {
      ...
      $("#email_settings_course_number").text(
        $(event.target).data("course-number")
      );
    ...
    $(".action-unenroll").click(function (event) {
      var isPaidCourse =
          $(event.target).data("course-is-paid-course") === "True",
...
$(document).ready(function () {
  edx.dashboard.legacy.init({
    ...
    changeEmailSettings:
      "${reverse('change_email_settings') | n, js_escaped_string}",
  });
});
